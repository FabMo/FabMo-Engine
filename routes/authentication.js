    ...
    authentication.passport.authenticate("local", function (err, user, info) {
        ...
        if (!user) {
            return res.send(401, {
                ...
                userAlreadyLogedIn: info.userAlreadyLogedIn,
            });
        }
...
var addUser = function (req, res, next) {
    ...
    if (currentUser && currentUser.isAdmin) {
        if (
            ...
            req.params.user.username == undefined ||
            req.params.user.password == undefined
        ) {
            res.send(200, {
                status: "error",
                message:
                    "you need to provide an object with a user object inside containing a username AND a password",
            });
            return;
        } else {
        ...
        res.send(200, {
            status: "error",
            message: "you need to be admin to register new users",
        });
        return;
    }
};
...
var getUsers = function (req, res, next) {
    ...
    if (currentUser && currentUser.isAdmin) {
        ...
        res.send(200, {
            status: "error",
            message: "you need to be admin to get users info",
        });
        return;
    }
};
...
var getUser = function (req, res, next) {
    ...
    if (
        ...
        res.send(200, {
            status: "error",
            message:
                "you need to be admin or request your own id to get the user info",
        });
        return;
    }
};
...
var getCurrentUser = function (req, res, next) {
    ...
    if (currentUser) {
        ...
        res.send(200, {
            status: "error",
            message: "you need to be connected to request your own user info",
        });
        return;
    }
};
...
var modifyUser = function (req, res, next) {
    ...
    if (
        ...
        if (!req.params.user) {
            res.send(200, {
                status: "error",
                message: "no user object provided",
            });
            return;
        }
        ...
        res.send(200, {
            status: "error",
            message:
                "you need to be admin or request your own id to modify the user info",
        });
        return;
    }
};
...
var deleteUser = function (req, res, next) {
    ...
    if (currentUser && currentUser.isAdmin) {
        ...
        res.send(200, {
            status: "error",
            message: "you need to be admin to delete users",
        });
        return;
    }
};
...
module.exports = function (server) {
    ...
    server.post(
        ...
        passport.authenticate("local"),
        addUser
    ); //only authenticated user can add new users.
    server.get(
