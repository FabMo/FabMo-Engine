...
function parseLine(line) {
    ...
    // Mnemonic command in the THEN of an IF/THEN: normalize its case too
    // (the runtime resolves handlers by exact uppercase name)
    if (obj.type == "cond" && obj.stmt && obj.stmt.type == "cmd") {
        obj.stmt.cmd = obj.stmt.cmd.toUpperCase();
    }
